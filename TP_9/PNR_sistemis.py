...
def find_near_zero(K, a, tolerance):
    ...
    # Busca el máximo de la curva para luego encontrar
    # el punto cercano a cero en la rama descendente
    t_max, _ = find_maximum(K, a)

    # Encuentra el punto donde y(t) es cercano a la tolerancia usando root_scalar
    result = root_scalar(equation, bracket=[t_max, 100], method='brentq')
...
# Punto 8.c - Se fuerza a cuatro veces el valor calibrado
a_estimada = 4 * a_estimada
print(f"Parámetro a forzado (4a): {a_estimada:.3f}")
